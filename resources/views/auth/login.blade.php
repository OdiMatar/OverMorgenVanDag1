...
<main class="page-shell">
    ...
    ">
        <h1 style="margin: 0 0 20px; color: #6d747d; font-size: 28px;">Inloggen</h1>
        ...
        <form method="POST" action="{{ route('login.store') }}" style="display: grid; gap: 14px;">
            ...
            <label style="display: grid; gap: 6px; color: #69717c; font-weight: 700;">
                E-mailadres
                <input name="email" type="email" value="{{ old('email') }}" required autofocus style="
                    min-height: 38px;
                    padding: 8px 10px;
            ...
            <label style="display: flex; gap: 8px; align-items: center; color: #69717c; font-size: 14px;">
        ...
        <p style="margin: 18px 0 0; color: #737982; font-size: 14px;">
            Nog geen account?
            <a href="{{ route('register') }}" style="color: #1c78b2; font-weight: 700;">Account aanmaken</a>
        </p>
    </section>
</main>
